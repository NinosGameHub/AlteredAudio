// FilterRow.jsx — FILTER TYPE list · primary knob cluster (+ small GAIN) · SLOPE / MODE.
(function () {
    ...
    return (
      <div style={{ display: "flex", gap: "14px", alignItems: "stretch" }}>
        ...
        <Panel style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "space-around", padding: "22px 16px" }}>
          ...
          <Knob label="GAIN" value={filter.gain} min={-18} max={18} defaultValue={0} bipolar
            size="var(--knob-md)" ticks={28}
            display={filter.gain.toFixed(1) + " dB"} onChange={(v) => set({ gain: v })} />
        </Panel>
